...
new class extends VoltComponent {
    ...
    public function mount()
    {
        ...
        $this->urlBase = route('busqueda.avanzada');
    ...
    {
        $filasValidas = array_filter($this->filas, fn($fila) => !empty($fila['termino']));
...
<div class="bg-white p-6 rounded-b-lg shadow-sm border-t border-gray-100 font-sans">
    ...
    <div wire:keydown.enter="aplicarFiltrado" class="space-y-5">
        ...
        <div wire:keydown.enter="aplicarFiltrado" class="space-y-5">
            ...
            <!-- Alerta de Validación Livewire -->
            @error('busqueda_vacia')
                <div class="bg-red-50 border-l-4 border-[#86212b] p-4 mb-4 rounded-r-md">
                    <div class="flex items-center">
                        <svg class="h-5 w-5 text-[#86212b] mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
