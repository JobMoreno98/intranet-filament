...
<body class="antialiased">
    <header class="border-b-2">
        <div class="mx-auto max-w-7xl px-6 py-4 flex flex-col md:flex-row gap-2 md:gap-8 items-between">
            <a href="{{ route('home') }}" class="font-bold text-xl">
                <span class="text-orange-500"><i class="bi bi-bookmark-fill"></i> Book</span>me
            </a>
            <nav>
            ...
            <div class="flex ml-0 md:ml-auto gap-2 md:gap-8 items-center">
                ...
                <a href="{{ route('login') }}"
                    class="text-sm md:text-base bg-red-400 rounded text-white font-bold py-1 px-6 hover:bg-red-800">{{ __('Log In') }}
                    / {{ __('Sign up') }}</a>
            </div>
        </div>
    </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                @foreach ($data as $key => $value)
                    <div class="p-6 rounded-md border bg-white flex flex-col gap-6 w-full shadow-xl">
                        <div>
                            <h2 class="text-xl font-bold text-center">{{ $value->fondoPrincipal }}</h2>
                        </div>
                        {{--  
                        <div>
                        ...
                        <p class="text-right mt-auto">
                            <a href="{{ route('coleccion.individual', ['tabla' => $value->claveFondoPrincipal, 'id' => $value->IdElemento]) }}"
                                target="_blank"
        ...
        <div class="px-2 py-20 mx-auto max-w-7xl">
            <div class="pt-12 border-t border-gray-300 flex flex-col md:flex-row gap-10 items-center">
                <div class="text-black flex flex-col">
                    <a href="/" class="font-bold text-xl mx-auto md:mx-0">
                        <span class="text-orange-500"><i class="bi bi-bookmark-fill"></i> Book</span>me
                    </a>
                ...
                <nav class="ml-0 md:ml-auto">
                    <ul class="flex flex-row gap-4">
                        <li>
                            <a href="" class="hover:text-orange-500">Solution</a>
                        </li>
                        <li>
