        ...
        <div class="sm:px-7 px-2 w-full py-20 flex flex-col gap-6">
                        ...
                        <select onchange="window.location.href = '?acervo_id=' + this.value"
                            ...
                            @foreach ($acervosDisponibles as $itemAcervo)
                                @if ($itemAcervo->acervo)
                                    <option value="{{ $itemAcervo->acervo_id }}"
                                        {{ request('acervo_id') == $itemAcervo->acervo_id ? 'selected' : '' }}>
            ...
            @php
                ...
                $cambios = [
                    ...
                    'personaje_principal' => 'Nombre de Personaje principal',
                    'personaje_secundario' => 'Nombre de Personaje secundario',
