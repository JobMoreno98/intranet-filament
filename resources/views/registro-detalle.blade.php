                ...
                <aside class="lg:hidden border-b border-zinc-800 bg-zinc-900 p-3 text-zinc-300">
                    <details class="group rounded-lg border border-zinc-800 bg-zinc-950">
                        <summary
                            ...
                            <span class="transition duration-200 group-open:rotate-180">▼</span>
                        </summary>
                        <div class="divide-y divide-zinc-800">
                            ...
                            <div class="p-4 space-y-1">
                                <span
                                    class="block text-zinc-500 uppercase text-[11px] font-semibold tracking-wider">Páginas</span>
...
@section('js')
    <script>
        // Dejamos que los datos vivan en el DOM de forma nativa como data-attributes
        document.documentElement.setAttribute('data-paginas', '@json($paginas)');
        document.documentElement.setAttribute('data-recurso-id',
            '{{ isset($registro) ? ($registro instanceof \Illuminate\Database\Eloquent\Model ? $registro->id : $registro['id'] ?? 0) : 0 }}'
        );
    </script>
@endsection
