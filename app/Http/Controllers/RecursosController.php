...
class RecursosController extends Controller
{
    ...
    {
        // Capturamos el ID de la sesión actual del navegador/usuario
        $sessionId = session()->getId();

        $payload = [
            'a' => $id, // ID del archivo
            'u' => auth()->id(), // ID del usuario
            's' => $sessionId, // ⚡ ¡AQUÍ ESTÁ! Inyectamos el ID de sesión para el middleware
    ...
    public function publico(Request $request, int $tabla, int $id)
    {
        ...
        $paginas = $recurso->archivos->sortBy('orden')->map(function ($archivo) use ($sessionId) {
